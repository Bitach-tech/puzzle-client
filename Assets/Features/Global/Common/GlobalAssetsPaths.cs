namespace Global.Common
{
    public static class GlobalAssetsPaths
    {
        ...
        public const string Overlay = _services + "Overlay/";
        public const string ServiceSDK = _services + "ServiceSDK/";
        ...
        public const string MessageBroker = _services + "MessageBroker/";
    }
}